export const pattern = {
  ...
  email: /^(?=.{2,50}$)[A-Za-zÅÄÖåäö]+(?:[ -][A-Za-zÅÄÖåäö]+)*$/,
  number: /^(?=.{2,50}$)[A-Za-zÅÄÖåäö]+(?:[ -][A-Za-zÅÄÖåäö]+)*$/,
  street: /^(?=.{2,50}$)[A-Za-zÅÄÖåäö]+(?:[ -][A-Za-zÅÄÖåäö]+)*$/,
  postal: /^(?=.{2,50}$)[A-Za-zÅÄÖåäö]+(?:[ -][A-Za-zÅÄÖåäö]+)*$/,
  city: /^(?=.{2,50}$)[A-Za-zÅÄÖåäö]+(?:[ -][A-Za-zÅÄÖåäö]+)*$/,
};
// export const pattern = {
//   name: /^(?=.{2,50}$)[A-Za-zÅÄÖåäö]+(?:[ -][A-Za-zÅÄÖåäö]+)*$/,
//   email:
...
//   number: /^(?:\+46|0)(?:7\d{8}|[2-9]\d{1,2}[ -]?\d{5,7})$/,
